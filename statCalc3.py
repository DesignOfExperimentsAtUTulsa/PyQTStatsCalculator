...
from PyQt5 import QtGui, QtCore, QtWidgets #import QMainWindow
...
class StatCalculator(QtWidgets.QMainWindow):#(QWidget):
    ...
    def load_data(self):        
       ...
       data_file_name = filename#"Historical Temperatures from Moose Wyoming.csv"
       header_row = 1 
    ...
    def getfile():
        printf("What is the tab delineated file you wish to read into memory?")
        filename = input() 
